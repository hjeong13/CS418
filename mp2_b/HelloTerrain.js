...
var eyePt = vec3.fromValues(0.0,0.1,0.2);
/** @global Direction of the view in world coordinates */
var org_viewDir = vec3.fromValues(0.0,0.05,-1.0);
var viewDir = vec3.fromValues(0.0,0.05,-1.0);
/** @global Up vector for view matrix creation, in world coordinates */
var org_up = vec3.fromValues(0.0,1.0,0.0);
...
//    var inverse_quat = quat.create();
    var moveDir = vec3.create();
    
    // Construct a temporary quaternion based on the Euler angles.
    quat.fromEuler(temp_quat, eulerX, eulerY, eulerZ);
    
    // Update the orientation quaternion using the temp
    quat.multiply(ori_quat, ori_quat, temp_quat);
    quat.normalize(ori_quat, ori_quat);

    // Update viewDir and up by rotating using ori_quat
    vec3.transformQuat(viewDir, org_viewDir, ori_quat);
    vec3.transformQuat(up, org_up, ori_quat);

    // Move forward
    vec3.scale(moveDir, viewDir, flightV);
...
// if keyboard is not pressed stop all rotation
